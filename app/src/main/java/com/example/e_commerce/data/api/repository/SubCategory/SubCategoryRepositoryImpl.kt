package com.example.e_commerce.data.api.repository.SubCategory
...
class SubCategoryRepositoryImpl @Inject constructor(
    ...
    override suspend fun getSubCategories(categoryId: String): ApiResult<List<SubCategoryDomain>> {
        return try {
