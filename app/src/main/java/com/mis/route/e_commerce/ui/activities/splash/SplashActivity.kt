...
import com.mis.route.e_commerce.ui.utils.PrefsManager
...
class SplashActivity : AppCompatActivity() {
    ...
    private fun navigateToAuth() {
        Handler(mainLooper).postDelayed({
            val nextIntent = if (PrefsManager.isLoginValid(this)) {
                // لو login صالح خلال آخر 30 يوم
                Intent(this, HomeActivity::class.java)
            } else {
                // لو المستخدم لم يعمل login أو مر عليه أكثر من 30 يوم
                Intent(this, AuthActivity::class.java) // AuthActivity يحتوي LoginFragment
            }
