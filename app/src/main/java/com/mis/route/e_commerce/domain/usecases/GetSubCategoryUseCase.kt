...
class GetSubCategoryUseCase @Inject constructor(val homeRepository: HomeRepository) {

    suspend fun execute(categoryId : String): ApiResult<List<Category>> = homeRepository.getSubCategory(categoryId)
}